...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowTitle('Image recognition system')
        ...
        self.initUI()
        self.center()
        # Connect to the displayed interface
    ...
    def initUI(self):
        ...
        self.btn_changex = QPushButton(" Upload pictures ")
        ...
        self.result = QLabel("Waiting recognition")
    ...
    def display_video(self):
        # First, turn off the 'Open' button
        # self.btn_open.setEnabled(False)
        # self.btn_change.setEnabled(True)
        # todo Execute the displayed logic here
