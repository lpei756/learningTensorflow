...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowTitle('Intelligent identification system')
    ...
    def change_img(self):
        ...
        # When the photo is taken, turn off the camera and return to the original state
